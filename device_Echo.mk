...
$(call inherit-product-if-exists, vendor/CUBOT/Echo/Echo-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/CUBOT/Echo/overlay
PRODUCT_PACKAGE_OVERLAYS += device/CUBOT/Echo/overlay # enable this to be able overlay a default wallpaper
