...
patch -p1 < ../../../device/CUBOT/Echo/patches/package_apps_settings/0001-add-MiraVision-in-Settings.patch
patch -p1 -b < ../../../device/CUBOT/Echo/patches/package_apps_settings/0002-android_settings_developer_info.patch
git clean -f -d
cd ../../..
cd system/core
...
patch -p1 < ../../device/CUBOT/Echo/patches/system_core/0007-use-mtk-serial-number.patch
cd ../..
cd bionic
