...
$(call inherit-product, device/CUBOT/Echo/vendor/copyfiles.mk)
$(call inherit-product, vendor/CUBOT/Echo/Echo-vendor-blobs.mk)
...
TARGET_OTA_ASSERT_DEVICE := CUBOT_Echo,CUBOT_Echo_sprout,CUBOT Echo,Echo
